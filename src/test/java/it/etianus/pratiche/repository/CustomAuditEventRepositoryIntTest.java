...
import it.etianus.pratiche.config.audit.AuditEventConverter;
import it.etianus.pratiche.domain.PersistentAuditEvent;
...
import static it.etianus.pratiche.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
